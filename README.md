...
<style>
  ...
  *{ margin:0; padding:0; box-sizing:border-box; }
  ...
  /* =========================================================
     5b. IMAGEN DESTACADA DE SECCIÓN
  ========================================================= */
  .section-photo{
    position:relative;
    width:100%;
  ...
  .section-photo::before{
    content:"";
    position:absolute; inset:0;
    background:linear-gradient(180deg, rgba(13,13,13,.05) 0%, rgba(13,13,13,.55) 78%, rgba(13,13,13,.85) 100%);
    z-index:1;
    pointer-events:none;
  }
  .section-photo::after{
    ...
    background:linear-gradient(135deg, transparent 49%, var(--red) 50%, transparent 51%);
    opacity:.9;
    z-index:2;
  }
...
<section id="picadas">
  <div class="wrap">
    ...
    <div class="section-photo reveal-up">
      <img src="images/picadas.jpg" alt="Picada FORJA: costilla, chorizo, chicharrón, patacón y papas al barril">
    </div>
...
<section id="shawarmas">
  <div class="wrap">
    ...
    <div class="section-photo reveal-up">
      <img src="images/shawarma.jpg" alt="Shawarma FORJA envuelto con carne, papas fritas y vegetales frescos">
    </div>
...
<section id="nachos">
  <div class="wrap">
    ...
    <div class="section-photo reveal-up">
      <img src="images/nachos.jpg" alt="Nachos FORJA con carne desmenuzada, guacamole, pico de gallo y yuquitas fritas">
    </div>
